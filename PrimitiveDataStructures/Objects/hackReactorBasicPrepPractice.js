...
function interpolate(string) {
  console.log("My favorite food is " + string + ".");
};

console.log(interpolate(turkey));
...
function indexOfString(string, indexOfString) {
  return string.indexOf(indexOfString);
}

console.log(indexOfString('Johnny', 'John'));
...
console.log(removeFromBack(['testOne', 'testTwo']));
...
function addToBack(array, itemToAdd) {
...
function addToFront(array, itemToAdd) {
...
function spliceInto(array, indexLocation, replacement) {
  array.splice(indexLocation, 1, replacement);
  return array;
};
...
function indexOfArray(array, input) {
...
function callJoin(array, joiningItem) {
  return array.join(joiningItem);
};

console.log(callJoin([1, 2], 'apple'))
